...
public class SnowyJungleEdgeBiome extends Biome {
    public SnowyJungleEdgeBiome() { super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.GRASS_DIRT_GRAVEL_CONFIG).precipitation(Biome.RainType.SNOW).category(Biome.Category.JUNGLE).depth(0.1F).scale(0.2F).temperature(0.0F).downfall(0.8F).waterColor(4159204).waterFogColor(329011).parent((String)null));
