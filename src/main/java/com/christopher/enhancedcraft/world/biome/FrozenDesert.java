...
public class FrozenDesert extends Biome {
    public FrozenDesert() {
        super((new Biome.Builder()).surfaceBuilder(SurfaceBuilder.DEFAULT, SurfaceBuilder.SAND_SAND_GRAVEL_CONFIG).precipitation(Biome.RainType.SNOW).category(Biome.Category.DESERT).depth(0.125F).scale(0.05F).temperature(0.0F).downfall(0.0F).waterColor(4159204).waterFogColor(329011).parent("snowy_tundra"));
