...
public enum PlatinumArmor implements IArmorMaterial {
    PLATINUM(EnhancedcraftMod.MOD_ID + ":platinum", 50, new int[]{3, 8, 6, 3}, 30, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 20.0F, () -> {return Ingredient.fromItems(ItemInit.PLATINUM_INGOT.get());
    });
