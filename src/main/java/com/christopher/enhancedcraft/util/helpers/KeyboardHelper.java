package com.christopher.enhancedcraft.util.helpers;
...
public class KeyboardHelper {
    ...
    @OnlyIn(Dist.CLIENT)
    public static boolean isHoldingLCtrl()
    {
        return InputMappings.isKeyDown(WINDOW, GLFW.GLFW_KEY_LEFT_CONTROL);
    }

    @OnlyIn(Dist.CLIENT)
    public static boolean isHoldingRCtrl()
    {
        return InputMappings.isKeyDown(WINDOW, GLFW.GLFW_KEY_RIGHT_CONTROL);
    }
}
